# actividad/views.py
"""Vistas para mostrar la actividad pública y logros de los usuarios."""
...
def actividades_usuario(request, nombre_usuario):
    """Devuelve las últimas actividades públicas de un usuario."""
...
def logros_usuario(request, nombre_usuario):
    """Lista los logros obtenidos por un usuario concreto."""
